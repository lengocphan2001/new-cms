                ...
                <table class="table table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __("labels.backend.$module_name.fields.machine_type") }}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>
                                    {{ $module_name_singular->stageGroup->name }}
                                </strong>
                            </td>
                            <td>
                                <strong>
                                    {{ $module_name_singular->machine_type }}
                                </strong>
                            </td>
                            <td>
                                <strong>
                            ...
                            <td>
                                <strong>
                                    {{ $module_name_singular->time_to_complete }}
                                </strong>
                            </td>
                            <td>
                                <strong>
                                    {{ $module_name_singular->number_of_employee }}
                                </strong>
                            </td>
                            <td class="text-end">
